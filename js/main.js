...
const channels = [
    ...
    { id: 'WN7sMNdvuGw', name: 'Como colocar sangria no Canva fácil' },
    { id: 'IuChKeIRlao', name: 'Desvendado - Como usar vetor no Canva de modo fácil' },
    { id: 'K6U7uqVxYlI', name: 'Como criar desenhos no Canva de modo fácil' },
    { id: 'U6U2TlI0KBU', name: 'Como usar elementos gráficos no Canva' },
    { id: '9HyV0uPZhVA', name: 'Como usar a moldura no Canva' },
    { id: 'qUg8v8-6J0o', name: 'Como usar a grade no Canva' },
    { id: 'o3_HMJw4iik', name: 'Como usar as tabelas no Canva' },
